...
const portfolioItems = [
  { id: 1, category: 'designing', imageSrc: image1, title: 'Project Name', description: 'Some description..' },
  { id: 2, category: 'mobile development', imageSrc: image2, title: 'Project Name', description: 'Some description..' },
  { id: 3, category: 'designing', imageSrc: image3, title: 'Project Name', description: 'Some description..' },
  { id: 4, category: 'mobile', imageSrc: image4, title: 'Project Name', description: 'Some description..' },
  { id: 5, category: 'designing development', imageSrc: image5, title: 'Project Name', description: 'Some description..' },
  { id: 6, category: 'mobile', imageSrc: image6, title: 'Project Name', description: 'Some description..' },
  { id: 7, category: 'designing development', imageSrc: image7, title: 'Project Name', description: 'Some description..' },
  { id: 8, category: 'mobile', imageSrc: image8, title: 'Project Name', description: 'Some description..' },
];
    ...
    <section id="portfolio">
      <div className="container">
        <div className="section-header">
          <h2 className="section-title text-center wow fadeInDown">Our Works</h2>
        ...
        <div className="portfolio-items">
          <TransitionGroup component={null}>
            {filteredItems.map((item) => (
              ...
              >
                <div className={`portfolio-item ${item.category}`} key={item.id}>
                  <div className="portfolio-item-inner">
                    <img className="img-responsive" src={item.imageSrc} alt={item.title} />
                    <div className="portfolio-info">
                      <h3>{item.title}</h3>
                      <p>{item.description}</p>
                      <a className="preview" href={item.imageSrc} rel="prettyPhoto">
